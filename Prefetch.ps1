...
Write-Host @"
 ...
 _    _      _                             ______ _            _                   
| |  | |    | |                            |  ___| |          (_)                  
| |  | | ___| | ___ ___  _ __ ___   ___    | |_  | | ___  _ __ _ _ __  _   _  ___  
| |/\| |/ _ | |/ __/ _ \| '_ ` _ \ / _ \   |  _| | |/ _ \| '__| | '_ \| | | |/ _ \ 
\  /\  |  __| | (_| (_) | | | | | |  __/   | |   | | (_) | |  | | | | | |_| | (_) |
 \/  \/ \___|_|\___\___/|_| |_| |_|\___|   \_|   |_|\___/|_|  |_|_| |_|\__, |\___/ 
                                                                      __/ |      
                                                                     |___/       
"@ -ForegroundColor Red
Write-Host ""
Write-Host "  Prefetch checker!" -ForegroundColor Red
Write-Host ""
...
if ($suspiciousFiles.Count) {
    Write-Host "Suspicious PFs files:" -ForegroundColor Yellow
